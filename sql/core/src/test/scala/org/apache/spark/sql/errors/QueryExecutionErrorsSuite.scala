...
import org.apache.spark.sql.{AnalysisException, DataFrame, Dataset, DisableBoson, QueryTest, Row, SaveMode}
...
class QueryExecutionErrorsSuite
  ...
  test("INCONSISTENT_BEHAVIOR_CROSS_VERSION: " +
    ...
    DisableBoson("Boson doesn't support datetime rebase mode yet")) {
