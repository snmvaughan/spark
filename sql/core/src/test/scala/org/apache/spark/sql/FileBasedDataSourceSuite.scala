      ...
      allFileBasedDataSources.foreach { format =>
        withTempPath { dir =>
          ...
          val fileScan = df.queryExecution.executedPlan collectFirst {
            ...
            case BosonBatchScanExec(BatchScanExec(_, f: FileScan, _, _, _, _), _) => f
          }
      ...
      Seq("parquet", "").foreach { useV1SourceList =>
        withSQLConf(SQLConf.USE_V1_SOURCE_LIST.key -> useV1SourceList) {
          ...
          val filters = df.queryExecution.executedPlan.collect {
            ...
            case b: BosonScanExec => b.dataFilters
            case b: BosonBatchScanExec => b.scan.asInstanceOf[FileScan].dataFilters
          }.flatten
